...
% Calculation of e^(w3hat theta3)
I = eye(3);
w3_hat  = [ 0 -l0/sqrt(l1^2 + l0^2) l1/sqrt(l1^2 + l0^2);  l0/sqrt(l1^2 + l0^2) 0 0; -l1/sqrt(l1^2 + l0^2) 0 0 ] ;
e_w3_hat = simplify(I + (sin(t3)*w3_hat) + ((1-cos(t3))*(w3_hat^2)))

psi1 = [0;0;0;0;0;1];
psi2 = [0;-l0;  0 ; -1 ; 0 ;0];
psi3 = [0;0;0;0;l1/sqrt(l1^2 + l0^2);l0/sqrt(l1^2 + l0^2)]; 
...
s3 = [ e_w3_hat(1,1) e_w3_hat(1,2) e_w3_hat(1,3) -l0*sin(t3) ; e_w3_hat(2,1) e_w3_hat(2,2) e_w3_hat(2,3) 0 ; e_w3_hat(3,1) e_w3_hat(3,2) e_w3_hat(3,3) l0*(1-cos(t3)); 0 0 0 1] ;
gst = [ 1 0 0 0 ; 0 1 0 l1+l2 ; 0 0 1 l0 ; 0 0 0 1] ; 
